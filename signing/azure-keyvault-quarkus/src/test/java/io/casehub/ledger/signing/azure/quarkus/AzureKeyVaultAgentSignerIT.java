...
/**
 * Quarkus integration test for {@link AzureKeyVaultAgentSigner}.
 *
 * <p>Uses a mocked {@link io.casehub.ledger.signing.azure.AzureKeyVaultClientWrapper} via test CDI producer.
 ...
 */
@QuarkusTest
class AzureKeyVaultAgentSignerIT {

    @Inject
    AgentSigner agentSigner;

    @Test
    void signsData_viaAzureKeyVault() throws Exception {
